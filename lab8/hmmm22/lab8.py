...
5       setn    r5 0        # sets r5 to 1. b =k-2
6       setn    r6 1        # sets r6 to 2. keeps track of count
7       add     r7 r4 r5    # adds r4 and r5 and places it in r7. C
8       write   r5          # print b
9       addn    r6 1        # increments the tracker by 1
10      copy    r5 r4       # sets b = a
11      copy    r4 r7       # sets a = c
12      sub     r8 r6 r1    # subtracting n from tracker
13      jgtzn   r8 15       # if k is greater than 0
14      jumpn    7          # jumps to calculating C
15      halt                # stops the program
